...
@Component({
  selector: 'app-graph-view-dialog',
  standalone: true,
  imports: [GraphVisualizerComponent, NgStyle, NgClass, MatButton, BaseChartDirective, MatButtonModule, MatDialogClose, MatDialogContent, MatDialogActions, MatDialogTitle, MatLabel, MatFormField, MatError, FormsModule, CommonModule, NgIf, MatFormFieldModule, MatInputModule, NgFor],
  templateUrl: './graph-view-dialog.component.html',
  styleUrl: './graph-view-dialog.component.scss'
})
export class GraphViewDialogComponent {
